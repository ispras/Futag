...
class FuzzDataProviderGenerator:
    ...
    def __gen_header(self, target_function_name):
        ...
        defaults = ["stdio.h", "stddef.h", "time.h",
                    "stdlib.h", "string.h", "stdint.h", "fuzzer/FuzzedDataProvider.h"]
    ...
    def __gen_union(self, param_name, gen_type_info):
        ...
        return {
            "gen_lines": [
                "//GEN_UNION\n",
                "auto " + param_name + " = provider.ConsumeIntegral<" + gen_type_info["type_name"] +">();\n",
            ],
            # "gen_lines": [
            #     "//GEN_UNION\n",
            #     gen_type_info["type_name"] + " " + param_name + ";\n",
    ...
    def __gen_input_file(self, param_name, gen_type_info):
        ...
        gen_lines += [
            "    return 0;\n",
            "}\n",
            "fwrite(file_buffer_" + str(self.file_idx - 1) +", 1, strlen(file_buffer_" + str(self.file_idx - 1) +
    ...
    def __gen_file_descriptor(self, param_name, gen_type_info):
        ...
        gen_lines = [
            "//GEN_FILE_DESCRIPTOR\n",
            "const char* file_buffer_"+str(self.file_idx - 1)+" = file_buffer_" +  str(self.file_idx - 1) + "_fdp.c_str();\n",
    ...
    def __gen_anonymous_function(self, func, param_id) -> bool:
        ...
        if param_id == len(func['params']):
            ...
            if self.file_idx > 0:
                ...
                for i in range(self.file_idx):
                    f.write("    std::string  file_buffer_" + str(i) + "_fdp = provider.ConsumeRandomLengthString();\n")
                    f.write("    const char *  file_buffer_" + str(i) + " = file_buffer_" + str(i) + "_fdp.c_str();\n")
                f.write(
    ...
    def __gen_target_function(self, func, param_id) -> bool:
        ...
        if param_id == len(func['params']):
            ...
            f.write("    FuzzedDataProvider provider(Fuzz_Data, Fuzz_Size);\n")
