...
RUN apt install -y libncurses-dev gcc-multilib g++ make gdb binutils python3 git openssh-client cmake wget xz-utils python3-pip texinfo binutils-gold binutils-dev automake autoconf
