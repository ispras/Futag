# Тестирование инструмента Futag

Futag обновился до LLVM 18.8.
По ссылке https://github.com/ispras/Futag/releases/tag/v3.0.1 можно скачать готовые пакеты инструмента:
* futag-3.0.1.tar.gz - Python-пакет
