...
tc = ToolchainConfig.from_futag_llvm(FUTAG_PATH) # конфигурация инструментов Futag
...
fuzzer = Fuzzer( # модуль для фаззинга
    "curl-7.85.0/futag-fuzz-drivers", # путь к папке, содержащей скомпилированные обертки
